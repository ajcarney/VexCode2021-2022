...
void Autons::pid_straight_drive() {
    ...
    // chassis.okapi_pid_straight_drive(1000, 7500, 1000, false, 0);
    // pros::delay(2000);
...
// Middle Mogo LEFT
    //Insert Piston Setpoints
    chassis.okapi_pid_straight_drive(1900, 7500, 2000, false, 0); //Drives to middle left mogo
    //Insert Claw Piston Clamp
    // chassis.okapi_pid_straight_drive(-1000, 7000, 1000, false, 0); //Drives backwards to score middle mogo
    //Insert Claw Piston Clamp
    //Insert Lift Movement up
}
